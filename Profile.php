...
<nav class="navbar navbar-inverse">
  ...
  <li><a  href="ADDImage.php">Add Image</a></li>
     ...
     <div class="dropdown">
	  <a href='Profile.php?hello=true'><span class="glyphicon glyphicon-bell"></span></a></span>
...
$sql = "select file from profile where name='".$_SESSION['name']."'";
...
if ($result->num_rows > 0) {
    ...
    if($row = $result->fetch_assoc()) {
		...
		echo "<p>".$_SESSION['name']. " your profile</p><br/></center>";
...
{
	echo "<p>".$_SESSION['name']. " your are new user select profile</p><br/></center>";
}
?>
</body>
</html>
