...
$_SESSION['id']=$data['total'];
//$sql = "INSERT INTO users VALUES(".(int)$data['total'].",".$_POST['name'].",".$_POST['email'].",".$_POST['password'].")";
$sql = "INSERT INTO users (id,name,email,password) VALUES (".$data['total'].",'".$_POST['name']."','".$_POST['email']."', '".$_POST['password']."')";
...
<nav class="navbar navbar-inverse">
  ...
  <li><a  href="ADDImage.php">Add Image</a></li>
     ...
     <div class="dropdown">
	 <a href='reg.php?hello=true'><span class="glyphicon glyphicon-bell"></span></a></span>
